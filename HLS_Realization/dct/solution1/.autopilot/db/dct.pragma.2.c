...
# 305 "/usr/local/Xilinx/Vivado/2019.2/common/technology/autopilot/etc/autopilot_ssdm_op.h"
...
{_ssdm_SpecArrayDimSize(input, 64);_ssdm_SpecArrayDimSize(output, 8);
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
_ssdm_SpecArrayPartition( output, 2, "COMPLETE", 0, "");
_ssdm_SpecArrayPartition( input, 1, "CYCLIC", 8, "");
...
{_ssdm_SpecArrayDimSize(input, 8);_ssdm_SpecArrayDimSize(output, 64);
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
_ssdm_SpecArrayPartition( input, 2, "COMPLETE", 0, "");
_ssdm_SpecArrayPartition( output, 1, "CYCLIC", 8, "");
 for (int row = 0; row < 8; row++)
    {
_ssdm_Unroll(1, 0, 8, "");
 for (int col = 0; col < 8; col++)
