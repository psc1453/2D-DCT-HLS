...
// ==============================================================
#ifndef __DCT_ama_addmuladdbkb__HH__
#define __DCT_ama_addmuladdbkb__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(DCT_ama_addmuladdbkb) {
    ...
    SC_CTOR(DCT_ama_addmuladdbkb):  simcore_ama_0_U ("simcore_ama_0_U") {
