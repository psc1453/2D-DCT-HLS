...
// ==============================================================
#ifndef __DCT_mul_mul_16s_1hbi__HH__
#define __DCT_mul_mul_16s_1hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(DCT_mul_mul_16s_1hbi) {
    ...
    SC_CTOR(DCT_mul_mul_16s_1hbi):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
