...
// ==============================================================
#ifndef __DCT_mac_muladd_16pcA__HH__
#define __DCT_mac_muladd_16pcA__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DCT_mac_muladd_16pcA) {
    ...
    SC_CTOR(DCT_mac_muladd_16pcA):  simcore_mac_9_U ("simcore_mac_9_U") {
