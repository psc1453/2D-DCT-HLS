...
// ==============================================================
#ifndef __DCT_mac_muladd_16rcU__HH__
#define __DCT_mac_muladd_16rcU__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DCT_mac_muladd_16rcU) {
    ...
    SC_CTOR(DCT_mac_muladd_16rcU):  simcore_mac_11_U ("simcore_mac_11_U") {
