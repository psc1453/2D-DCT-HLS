...
// ==============================================================
#ifndef __DCT_mac_muladd_16fYi__HH__
#define __DCT_mac_muladd_16fYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DCT_mac_muladd_16fYi) {
    ...
    SC_CTOR(DCT_mac_muladd_16fYi):  simcore_mac_1_U ("simcore_mac_1_U") {
