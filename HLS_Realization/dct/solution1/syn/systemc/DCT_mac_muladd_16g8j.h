...
// ==============================================================
#ifndef __DCT_mac_muladd_16g8j__HH__
#define __DCT_mac_muladd_16g8j__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DCT_mac_muladd_16g8j) {
    ...
    SC_CTOR(DCT_mac_muladd_16g8j):  simcore_mac_2_U ("simcore_mac_2_U") {
