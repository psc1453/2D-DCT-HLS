...
// ==============================================================
#ifndef __DCT_mac_muladd_16ocq__HH__
#define __DCT_mac_muladd_16ocq__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DCT_mac_muladd_16ocq) {
    ...
    SC_CTOR(DCT_mac_muladd_16ocq):  simcore_mac_8_U ("simcore_mac_8_U") {
