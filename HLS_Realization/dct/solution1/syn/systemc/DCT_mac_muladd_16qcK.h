...
// ==============================================================
#ifndef __DCT_mac_muladd_16qcK__HH__
#define __DCT_mac_muladd_16qcK__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DCT_mac_muladd_16qcK) {
    ...
    SC_CTOR(DCT_mac_muladd_16qcK):  simcore_mac_10_U ("simcore_mac_10_U") {
