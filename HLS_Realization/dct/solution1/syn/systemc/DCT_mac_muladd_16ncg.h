...
// ==============================================================
#ifndef __DCT_mac_muladd_16ncg__HH__
#define __DCT_mac_muladd_16ncg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DCT_mac_muladd_16ncg) {
    ...
    SC_CTOR(DCT_mac_muladd_16ncg):  simcore_mac_7_U ("simcore_mac_7_U") {
