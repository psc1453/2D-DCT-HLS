...
// ==============================================================
#ifndef __DCT_mac_muladd_16vdy__HH__
#define __DCT_mac_muladd_16vdy__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DCT_mac_muladd_16vdy) {
    ...
    SC_CTOR(DCT_mac_muladd_16vdy):  simcore_mac_15_U ("simcore_mac_15_U") {
