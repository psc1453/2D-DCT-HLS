...
// ==============================================================
#ifndef __DCT_mac_muladd_16ibs__HH__
#define __DCT_mac_muladd_16ibs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DCT_mac_muladd_16ibs) {
    ...
    SC_CTOR(DCT_mac_muladd_16ibs):  simcore_mac_3_U ("simcore_mac_3_U") {
