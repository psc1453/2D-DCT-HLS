...
// ==============================================================
#ifndef __DCT_mul_mul_16s_1dEe__HH__
#define __DCT_mul_mul_16s_1dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(DCT_mul_mul_16s_1dEe) {
    ...
    SC_CTOR(DCT_mul_mul_16s_1dEe):  ACMP_smul_su_U ("ACMP_smul_su_U") {
