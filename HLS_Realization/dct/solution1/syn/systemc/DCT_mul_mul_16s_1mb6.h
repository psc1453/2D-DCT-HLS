...
// ==============================================================
#ifndef __DCT_mul_mul_16s_1mb6__HH__
#define __DCT_mul_mul_16s_1mb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(DCT_mul_mul_16s_1mb6) {
    ...
    SC_CTOR(DCT_mul_mul_16s_1mb6):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
